...
![键线式各种线的含义](/assets/1024px-Skeletal_formula_samples_stereochemistry.svg.png)
...
![甾醇键线式](/assets/Sterol.svg)

胆固醇化学式为C27H46O，是固态、无色的结晶，结构如下所示。

![胆固醇结构](/assets/2560px-Cholesterol.svg.png)
![胆固醇结构](/assets/Cholesterol_molecule_ball.png)
...
术语“脂肪”常特指[甘油三酯类（即油脂）](#甘油)，它们是一群植物油和动物脂肪组织的主要成分。**口语上，脂肪多指室温下呈固态的油脂（室温下呈液态的油脂称作油）**，多来源于人和动物体内的脂肪组织。

**脂肪的化学结构是甘油三酯**，均为 1甘油＋3脂肪酸→1甘油三酯（油脂）＋3水。 
...
![丙三醇](/assets/Glycerin_Skelett.svg.png)
...
<table class="wikitable" style="text-align:center" align="center">
    <tbody>
        ...
        <tr bgcolor="#FFFFFF">
            <td valign="center">
                <figure class="mw-halign-center" typeof="mw:File">
                    <img src="/assets/Fat-Conformation-Sat.gif" decoding="async" width="200" height="167" class="mw-file-element"  data-file-width="278" data-file-height="232"/>
                    <figcaption></figcaption>
                </figure>
            </td>
            <td valign="center">
        ...
        <tr>
            <td>饱和的碳原子（每个碳原子与2个氢原子结合）以单键连接。
            </td>
            <td>不饱和的碳原子（每个碳原子与1个氢原子结合）以双键连接，“顺式”结构。
            </td>
            <td>不饱和的碳原子（每个碳原子与1个氢原子结合）以双键连接，“反式”结构。
            </td>
        </tr>
    </tbody>
</table>

关于球棍模型(ball-and-stick model)的棍子长度，根据[wikipedia](https://en.wikipedia.org/wiki/Ball-and-stick_model)，确实会表示原子间的距离。
...
饱和脂肪酸（saturated fatty acid）：烃类基团是全由单键构成的烷烃基。
...
![蛋白质结构中氨基酸和丙氨酸通过肽键（用方块标出）连接在一起](/assets/Peptide-Figure-Revised.png)
...
![脱氧核糖核酸的化学结构](/assets/1280px-DNA_chemical_structure_zh.png)
...
![端粒酶RNA](/assets/Ciliate_telomerase_RNA.JPG)

#### 内含子和外显子

内含子是一个基因中非编码DNA片段。
![UTR是非翻译区，起点终点标志untranslated region](/assets/Pre-mRNA_to_mRNA.svg.png)
...
![氯化氰](/assets/Cyanogen-chloride.svg.png)
